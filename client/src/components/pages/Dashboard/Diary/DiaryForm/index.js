...
const DiaryForm = props => (
  <Fragment>
     <Button variant="danger btn-block searchbutton" onClick={props.handleShow}>
      ...
      <div className="directionstext"> or manually enter the food information below</div>
  ...
  <div className="col-md-3 headerMeal">
    Meal
    </div>
    <div className="col-md-3 headerDescr">
    Description
    </div>
    <div className="col headerCal">
    Calories
    </div>
    </div>
